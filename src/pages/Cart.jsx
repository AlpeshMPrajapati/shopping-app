...
const Cart = () => {
  ...
  return (
    <div className='max-w-[1200px] flex flex-col md:flex-row justify-center mx-auto'>
      {
        cart.length > 0 ? 
        ...
        (<div className='min-h-[80vh] flex flex-col items-center justify-center'>
          ...
          <Link to='/'>
            <button className='bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 px-10 tracking-wider uppercase '>Shop Now</button>
          </Link>
        </div>)
      }
    </div>
